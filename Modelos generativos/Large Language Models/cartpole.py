...
def compute_returns(rewards):
    ...
    # Compute the discounted cumulative sum in reverse order and then
    ...
    for episode in range(1, num_episodes + 1):
        ...
        while True:
            ...
            if done or truncation: # if the episode is done or truncated
                ...
                # Compute the returns (discounted sum of rewards) for the episode
                returns = compute_returns(episode_reward)

                # Compute the loss for the episode using the log probabilities and returns
